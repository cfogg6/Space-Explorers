...
PROGNAME = SpaceFighter

# The object files you want to compile into your program
# This should be a space (SPACE!) separated list of .o files
OFILES = hw9.o white_ship_small.o asteroid0.o asteroid1.o asteroid2.o asteroid3.o start_screen.o game_over.o myLib.o text.o font.o

# The header files you have created.
# This is necessary to determine when to recompile for files.
# This should be a space (SPACE!) separated list of .h files
HFILES = white_ship_small.h asteroid0.h asteroid1.h asteroid2.h asteroid3.h start_screen.h game_over.h myLib.h text.h
